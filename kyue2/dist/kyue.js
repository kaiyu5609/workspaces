...
(function (global, factory) {
    ...
    (global = global || self, global.kyue = factory(global.konva));
}(this, function (Konva) { 'use strict';

    Konva = Konva && Konva.hasOwnProperty('default') ? Konva['default'] : Konva;
    ...
    strats.methods = function (parentVal, childVal) {
      ...
      let res = childVal === undefined ? parentVal : parentVal ? mergeOptions(parentVal, childVal) : childVal; // console.log('res', res)
    ...
    function initExtend(Kyue) {
      ...
      Kyue.extend = function (extendOptions) {
        ...
        Sub.extendOptions = extendOptions; // TODO
        // cache constructor
